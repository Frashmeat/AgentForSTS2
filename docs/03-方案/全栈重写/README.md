...
>
> 权威入口：上级入口为 `docs/03-方案/README.md`；阶段执行以本文和当前收口计划为准。
>
> 最后更新：2026-05-29
...
- [桌面端 MVP 收口计划](./进行中/2026-05-29-桌面端MVP收口计划.md)：本阶段最新执行入口。
...
1. 先读本文确认阶段边界。
2. 再读 [桌面端 MVP 收口计划](./进行中/2026-05-29-桌面端MVP收口计划.md)。
3. 需要追溯决策时读 [Q 决议汇总](./进行中/2026-05-11-Q决议汇总.md)。
4. 需要执行验证时读 [Windows 冒烟测试清单 v3](./进行中/2026-05-20-Windows冒烟测试清单-v3.md)。
