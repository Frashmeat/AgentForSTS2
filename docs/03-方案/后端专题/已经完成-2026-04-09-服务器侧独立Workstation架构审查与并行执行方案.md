...
本文默认遵循 [已经完成-2026-04-10-后端双角色与服务器内部执行器边界收口方案.md](/I:/WebCode/AgentTheSpire/docs/03-方案/后端专题/已经完成-2026-04-10-后端双角色与服务器内部执行器边界收口方案.md) 的上位口径：
...
本文与 [已经完成-2026-03-27-后端设计详情.md](/F:/WebCode/AgentForSTS2/docs/03-方案/后端专题/已经完成-2026-03-27-后端设计详情.md) 的大方向一致，但比那份文档更具体。
