...
本轮允许破坏性合同升级，不保留会形成双重事实来源的临时兼容层。Order 1-7 已完成通用地基与 Relic/Card/Potion/Power 扩展；当前进入 Order 8 Batch/Complex 和最终门禁。每个 Order 完成受影响机器门禁后自动提交；最终集中执行新候选与人工安装验收。
...
- Order 8（下一步）：Item Library Batch/Complex、child Run/retry、Build/Package、全量机器门禁与最终人工验收。
