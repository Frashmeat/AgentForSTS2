...
本轮允许破坏性合同升级，不保留会形成双重事实来源的临时兼容层。Order 1-8 已完成通用地基、Relic/Card/Potion/Power、Batch/Complex 和最终机器门禁。下一阶段不是继续补地基，而是在独立授权下生成绑定当前提交的新候选并完成人工安装/真实游戏验收，随后讨论下一批类型与资源能力。
