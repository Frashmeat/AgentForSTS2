...
本轮允许破坏性合同升级，不保留会形成双重事实来源的临时兼容层。Order 1-5 已完成通用地基、Relic Gate 和 Card 扩展；当前进入 Order 6 Potion。每个 Order 完成受影响机器门禁后自动提交；最终集中执行新候选与人工安装验收。
