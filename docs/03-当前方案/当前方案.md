...
- Order 3（实现已落地，等待完整机器门禁收口）：新增 composition-plan Recipe/Feature、默认 Standard 的 profile editor、Custom 参数、分页/过滤 Draft review 和通用 Composition Studio；STS2 Character catalog 仍由 Order 5 声明。
