...
export default function App() {
  ...
  const { knowledgeStatus, handleRefreshKnowledge } = useKnowledgeStatusFlow();
    ...
    <div className="min-h-screen bg-[var(--workspace-bg)] text-slate-800">
      <Routes>
        ...
        <Route
          ...
          element={
            isAuthAvailable ? (
              <LoginPage onStatusNotice={showStatusNotice} />
            ) : (
              buildPlatformAuthUnavailableElement(
                "当前环境不支持登录",
                "这是本机工作站模式，未接入独立 Web 平台服务，因此登录与注册入口不可用。",
              )
            )
          }
        />
        <Route
          ...
          element={
            isAuthAvailable ? (
              <RegisterPage onStatusNotice={showStatusNotice} />
            ) : (
              buildPlatformAuthUnavailableElement(
                "当前环境不支持注册",
                "这是本机工作站模式，未接入独立 Web 平台服务，因此无法创建平台账号。",
              )
            )
          }
        />
        <Route
          ...
          element={
            isAuthAvailable ? (
              <VerifyEmailPage onStatusNotice={showStatusNotice} />
            ) : (
              buildPlatformAuthUnavailableElement(
                "当前环境不支持邮箱验证",
                "请先接入独立 Web 平台服务，再使用平台账号验证链路。",
              )
            )
          }
        />
        <Route
          ...
          element={
            isAuthAvailable ? (
              <ForgotPasswordPage onStatusNotice={showStatusNotice} />
            ) : (
              buildPlatformAuthUnavailableElement(
                "当前环境不支持密码找回",
                "请先接入独立 Web 平台服务，再使用平台账号密码找回功能。",
              )
            )
          }
        />
        <Route
          ...
          element={
            isAuthAvailable ? (
              <ResetPasswordPage onStatusNotice={showStatusNotice} />
            ) : (
              buildPlatformAuthUnavailableElement(
                "当前环境不支持密码重置",
                "请先接入独立 Web 平台服务，再使用平台账号密码重置功能。",
              )
            )
          }
        />
        <Route
          ...
          element={
            isAuthAvailable ? (
              ...
              buildPlatformAuthUnavailableElement(
                "当前环境未启用用户中心",
                "这是本机工作站模式。只有接入独立 Web 平台服务后，用户中心、任务记录和次数池才可用。",
              )
            )
          }
        />
        <Route
          ...
          element={
            isAuthAvailable ? (
              <UserCenterJobDetailPage />
            ) : (
              buildPlatformAuthUnavailableElement(
                "当前环境未启用用户中心",
                "这是本机工作站模式。只有接入独立 Web 平台服务后，平台任务详情才可用。",
              )
            )
          }
        />
        <Route
          ...
          element={
            isAuthAvailable ? (
              ...
              buildPlatformAuthUnavailableElement(
                "当前环境未启用管理台",
                "这是本机工作站模式。只有接入独立 Web 平台服务后，统一管理台才可用。",
              )
            )
          }
        >
        ...
        <Route path="/admin/runtime-audit" element={<Navigate to="/admin/audit" replace />} />
