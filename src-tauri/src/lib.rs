...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::stage2::list_composition_drafts,
            commands::stage2::get_composition_draft,
            commands::stage2::update_composition_draft,
            commands::stage2::delete_composition_draft,
            commands::stage2::confirm_composition_draft,
            commands::stage2::get_resource_catalog,
            commands::stage2::list_resource_assets,
            commands::stage2::get_resource_preview,
            commands::stage2::select_resource,
            commands::stage2::submit_feature,
            commands::stage2::list_execution_graphs,
            commands::stage2::get_execution_graph,
            commands::stage2::pause_execution_graph,
            commands::stage2::cancel_execution_graph,
            commands::stage2::resume_execution_graph,
            commands::stage2::submit_composition_item_feedback,
