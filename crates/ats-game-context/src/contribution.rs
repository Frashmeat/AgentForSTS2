...
mod tests {
    ...
    fn pack() -> LoadedGamePack {
        let json = r#"{"schemaVersion":2,"id":"fixture-game","displayName":"Fixture","contributions":[{"slotId":"log.analyze.rules","featureId":"log.analyze","schema":{"id":"pack.log-rules","version":1},"requiredPrimitives":["log.parser"],"payload":{"format":"fixture"}}]}"#;
