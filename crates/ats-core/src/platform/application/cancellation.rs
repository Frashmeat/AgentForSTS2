...
use crate::platform::domain::{CancellationReason, RunId};
...
impl CancellationToken {
    ...
    /// Records the first cancellation reason and wakes every current waiter.
    /// Later callers cannot rewrite the lifecycle source.
